...
public class DiscreteFragment extends BaseFragment {
    ...
    protected void initView(View root) {
        ...
        //set custom tickmark at tickmark index [1] and [3]
        tick_drawable.setCustomTickMarkDrawable(getResources().getDrawable(R.drawable.selector_custom_tick_mark_long), 1);
        tick_drawable.setCustomTickMarkDrawable(getResources().getDrawable(R.drawable.selector_custom_tick_mark_long), 3);
